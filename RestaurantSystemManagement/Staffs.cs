    ...
    public partial class Staffs : Form
    {
        ...
        private void DataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                {
                    int empId = int.Parse(dataGridView1.Rows[e.RowIndex].Cells["ID"].Value.ToString());
                    if (DialogResult.Yes == MessageDialog.ShowDialog("delete"))
                    {
                        Program.dbase.Delete("DELETE FROM Employee WHERE ID = "+empId+"");
                    }
                ...
                else if (dataGridView1.Columns[e.ColumnIndex].Name == "تعديل")
                {
                    ...
                    StaffsDialog sd = new StaffsDialog(empId);
                    sd.ShowDialog();
                    RefreashDataGridView();
                }
            }
